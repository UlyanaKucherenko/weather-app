...
export const weather = {
  ...
  async getWeather(params: ParamsType) {
    return await client.get(`${process.env.REACT_APP_BASE_URL}/${WEB_API_ROUTES.weather.current}`, {params});
  },

  async getWeatherAllDays(params: ParamsType) {
    return await client.get(`${process.env.REACT_APP_BASE_URL}/${WEB_API_ROUTES.weather.forecast}`, {params});
  },
...
//   },
//
//   getWeatherAllDays(params: ParamsType) {
//     return Promise.resolve({
//       data: {
//       data: [
//         {
